---
title: 'OpenCV Task3：色彩空间'
date: 2019-07-09 14:47:37
tags: [OpenCV]
published: true
hideInList: false
feature: /post-images/opencv-task3se-cai-kong-jian.png
---
# 色彩空间
```python
import cv2 as cv
...
#    capture = cv.VideoCapture("G:/cv.gif")
...
cv.namedWindow("colin", cv.WINDOW_AUTOSIZE)  # 创建窗口, 窗口尺寸自动调整
